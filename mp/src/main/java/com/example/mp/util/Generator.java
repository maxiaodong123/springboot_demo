...
public class Generator {
    ...
    public static void main(String[] args) {
        String packageName = "com.example.mp";
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String author, String database, String... tableNames) {
        ...
        String dbUrl = "jdbc:mysql://47.98.164.156:3306/" + database + "?useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false";
